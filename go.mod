...
require (
	...
	github.com/jedisct1/go-minisign v0.0.0-20230513092556-d96eb068239a // indirect
	...
	github.com/letsencrypt/boulder v0.0.0-20230728164547-8d7b87c9cad1 // indirect
